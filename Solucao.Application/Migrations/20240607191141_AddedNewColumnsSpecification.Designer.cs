...
namespace Solucao.Application.Migrations
{
    ...
    [Migration("20240607191141_AddedNewColumnsSpecification")]
    partial class AddedNewColumnsSpecification
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Solucao.Application.Data.Entities.CalendarEquipamentConsumable", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("Id")
                    ...
                    b.ToTable("CalendarEquipamentConsumables");
                });

            modelBuilder.Entity("Solucao.Application.Data.Entities.CalendarSpecificationConsumables", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("Id")
                    ...
                    b.ToTable("CalendarSpecificationConsumables");
                });
            ...
            modelBuilder.Entity("Solucao.Application.Data.Entities.EquipamentConsumable", b =>
                {
                    ...
                    b.ToTable("EquipamentConsumables");
                });
            ...
            modelBuilder.Entity("Solucao.Application.Data.Entities.CalendarEquipamentConsumable", b =>
                {
                    b.HasOne("Solucao.Application.Data.Entities.Calendar", "Calendar")
                        .WithMany("CalendarEquipamentConsumables")
            ...
            modelBuilder.Entity("Solucao.Application.Data.Entities.CalendarSpecificationConsumables", b =>
                {
                    b.HasOne("Solucao.Application.Data.Entities.Calendar", "Calendar")
                        .WithMany("CalendarSpecificationConsumables")
                        .HasForeignKey("CalendarId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Solucao.Application.Data.Entities.EquipamentConsumable", b =>
                {
                    b.HasOne("Solucao.Application.Data.Entities.Consumable", "Consumable")
                        .WithMany("EquipamentConsumables")
                        .HasForeignKey("ConsumableId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
